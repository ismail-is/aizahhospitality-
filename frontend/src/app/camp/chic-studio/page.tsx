...
const TentDetail = () => {
    ...
    const images = [
      { src: "https://a0.muscache.com/im/pictures/hosting/Hosting-1371793908085095704/original/d3d75a84-12ed-4207-874b-df2ad6566aea.jpeg?im_w=960", alt: "Image 1" },
      { src: "https://a0.muscache.com/im/pictures/hosting/Hosting-1371793908085095704/original/a40448af-47d6-4022-bc47-f781e6cc73dd.jpeg?im_w=720", alt: "Image 2" },
      { src: "https://a0.muscache.com/im/pictures/hosting/Hosting-1371793908085095704/original/a75e644c-e735-42c9-b8a9-6cebb93567da.jpeg?im_w=720", alt: "Image 3" },
      { src: "https://a0.muscache.com/im/pictures/hosting/Hosting-1371793908085095704/original/e21080d3-01ac-4f5d-aacb-402b74dd88ae.jpeg?im_w=720", alt: "Image 4" },
      { src: "https://a0.muscache.com/im/pictures/hosting/Hosting-1371793908085095704/original/cd1cfc16-1d9c-4eda-83d9-35bc23203db4.jpeg?im_w=720", alt: "Image 5" },
    ];
                        ...
                        <div className="flex max-lg:flex-col-reverse gap-y-10 justify-between">
                            <div className="content xl:w-3/3 lg:w-[100%] lg:pr-[15px] w-full">
                                ...
                                <div className="flex items-center  gap-6">
                                    ...
                                    <h1 style={{fontSize:'26px',color:'black'}}>Chic studio+metroaccess/downtown</h1>
                                    </div>
                        ...
                        <div className="flex max-lg:flex-col-reverse gap-y-10 justify-between">
                            <div className="content xl:w-3/3 lg:w-[100%] lg:pr-[15px] w-full">
                                ...
                                <div className="flex items-center  gap-6 pb-4">
                                    ...
                                    <div className="body2 text-variant mt-3" >This special place is close to everything, making it easy to plan your visit unique interior with outstanding sheikh Zahid road view attach to business bay metro station. Definitely place for nightlife and easy access to all best places In Dubai.</div>
