...
const TentDetail = () => {
    ...
    const images = [
      { src: "https://a0.muscache.com/im/pictures/hosting/Hosting-1343565823386374663/original/e85a84a0-b7ea-4a97-942d-32c9717cea5c.jpeg?im_w=1200", alt: "Image 1" },
      { src: "https://a0.muscache.com/im/pictures/hosting/Hosting-1343565823386374663/original/2dd4ecd2-7dc9-4359-b4b8-c7fb608ea568.jpeg?im_w=720", alt: "Image 2" },
      { src: "https://a0.muscache.com/im/pictures/hosting/Hosting-1343565823386374663/original/7089b832-9e45-4f01-8ded-33ecd4566b5f.jpeg?im_w=720", alt: "Image 3" },
      { src: "https://a0.muscache.com/im/pictures/hosting/Hosting-1343565823386374663/original/2ef9f577-d58b-41c5-9e2e-351f59a4d49c.jpeg?im_w=720", alt: "Image 4" },
      { src: "https://a0.muscache.com/im/pictures/hosting/Hosting-1343565823386374663/original/762c2d22-bb75-4f56-8d8d-c33bfa12ea93.jpeg?im_w=720", alt: "Image 5" },
    ];
                        ...
                        <div className="flex max-lg:flex-col-reverse gap-y-10 justify-between">
                            <div className="content xl:w-3/3 lg:w-[100%] lg:pr-[15px] w-full">
                                ...
                                <div className="flex items-center  gap-6">
                                    ...
                                    <h1 style={{fontSize:'26px',color:'black'}}>Refined luxury in business bay/walk - Dubai mall</h1>
                                    </div>
                        ...
                        <div className="flex max-lg:flex-col-reverse gap-y-10 justify-between">
                            <div className="content xl:w-3/3 lg:w-[100%] lg:pr-[15px] w-full">
                                ...
                                <div className="flex items-center  gap-6 pb-4">
                                    ...
                                    <div className="body2 text-variant mt-3" >Experience style and comfort at this centrally located gem, nestled next to the stunning Bay Square. Enjoy the convenience of a short walk to Downtown Dubai and the iconic Dubai Mall. This unique space offers the perfect blend of tranquility and luxury, making it an ideal choice for both families and those seeking a vibrant atmosphere. Stay here and discover the most happening spots right at your doorstep—you’ll thank yourself later!</div>
                                    {/* <div className="heading6 mt-6">The space</div>
                                    <div className="body2 text-variant mt-3"  >Stylish studio in Business Bay, Dubai – Luxury & Comfort
                                    </div>
                                    <div className="body2 text-variant mt-3 border-t border-outline "  >Welcome to your perfect stay in the heart of Business Bay, Dubai! This elegant 1BHK apartment offers a blend of luxury and convenience, ideal for business travelers and vacationers alike.</div> */}
                                    </div>
