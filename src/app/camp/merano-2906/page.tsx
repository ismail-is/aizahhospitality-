...
const MeranoTwo   = () => {
    ...
    const images = [
      { src: "/images/allimg/rooms/Merano-2906/4.png", alt: "Image 1" },
      { src: "/images/allimg/rooms/Merano-2906/2.png", alt: "Image 2" },
      { src: "/images/allimg/rooms/Merano-2906/3.png", alt: "Image 3" },
      { src: "/images/allimg/rooms/Merano-2906/1.png", alt: "Image 4" },
      { src: "/images/allimg/rooms/Merano-2906/5.png", alt: "Image 5" },
      { src: "/images/allimg/rooms/Merano-2906/6.png", alt: "Image 5" },
                        ...
                        <div className="flex max-lg:flex-col-reverse gap-y-10 justify-between">
                            <div className="content xl:w-3/3 lg:w-[100%] lg:pr-[15px] w-full">
                                ...
                                <div className="flex items-center  gap-6">
                                    ...
                                    <h1 style={{fontSize:'26px',color:'black'}}>Merano 2906</h1>
                                    </div>
                        ...
                        <div className="flex max-lg:flex-col-reverse gap-y-10 justify-between">
                            <div className="content xl:w-3/3 lg:w-[100%] lg:pr-[15px] w-full">
                                ...
                                <div className="flex items-center  gap-6">
                                    ...
                                    <h2 style={{color:'black'}}> Skyline Views | Urban Oasis</h2>
                                    </div>
                        ...
                        <div className="flex max-lg:flex-col-reverse gap-y-10 justify-between">
                            <div className="content xl:w-3/3 lg:w-[100%] lg:pr-[15px] w-full">
                                ...
                                <div className="flex items-center  gap-6 pb-4">
                                    ...
                                    <div className="body2 text-variant mt-3" >Experience modern city living in this stylish studio apartment located just minutes from Dubai Mall and Downtown Dubai. Ideal for both business and leisure travelers, the apartment offers seamless metro access, making it easy to explore the city.</div>
                                    <div className="body2 text-variant mt-3" >Designed with comfort and functionality in mind, the space includes a fully equipped kitchen, high-speed WiFi, premium bedding, and all essential amenities for a relaxing stay.</div>
                                    {/* <div className="heading6 mt-6">The space</div> */}
                                    <div className="body2 text-variant mt-3"  >Key Features
                                          <ul>
                                    <li className='list-disc body2 ml-5'>Accommodates up to 3 guests</li>
                                    <li className='list-disc body2 ml-5'>Centrally located in Business Bay</li>
                                    <li className='list-disc body2 ml-5'>Short distance to Downtown attractions</li>
                                    <li className='list-disc body2 ml-5'>Modern interiors with functional design</li>
