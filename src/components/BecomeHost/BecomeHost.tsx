            ...
            <div className="become-host lg:pt-20 md:pt-14 pt-10 " style={{marginTop:'-120px'}}>
                <div className="container">
                    <div className="content-main xl:h-auto h-[500px] rounded-[20px] overflow-hidden relative">
                        <Image
                            src={'/images/other/bg-becomehost.png'}
                            width={4000}
                            height={3000}
                            alt='bg-becomehost'
                            priority={true}
                        ...
                        />
                        <div className="text-content bg-transparent rounded-[20px] xl:w-[40%] lg:w-[50%] md:w-[60%] py-6 md:px-8 px-6 absolute max-md:right-6 left-6 bottom-10">
                            {/* <div className="heading4">List your accommodation on Glamp Hub, join Us Now!</div>
                            ...
                            <Link href={'#!'} className='button-main mt-5'>Your Host</Link>
                        </div>
                    </div>
                </div>
            </div>
