                            ...
                            {/* <div className="flex items-center flex-wrap gap-4">
                                ...
                                <div className="list-social flex items-center flex-wrap gap-3">
                                    <Link href={'https://www.facebook.com/'} target='_blank'
                                        className='bg-white duration-300 hover:bg-[#446398] hover:text-white w-10 h-10 rounded-full flex items-center justify-center'
                                    >
                        ...
                        <div className="footer-main flex justify-between flex-wrap gap-y-8 lg:py-10 md:py-8 py-6">
                            <div className="company-infor lg:w-1/4 sm:w-1/2">
                                <div className="flex items-center gap-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                                        <path d="M26.43 16.1254C25.785 16.1254 25.275 15.6004 25.275 14.9704C25.275 14.4154 24.72 13.2604 23.79 12.2554C22.875 11.2804 21.87 10.7104 21.03 10.7104C20.385 10.7104 19.875 10.1854 19.875 9.55539C19.875 8.92539 20.4 8.40039 21.03 8.40039C22.53 8.40039 24.105 9.21039 25.485 10.6654C26.775 12.0304 27.6 13.7254 27.6 14.9554C27.6 15.6004 27.075 16.1254 26.43 16.1254Z" fill="#32548e" />
                                        <path opacity="0.5" d="M31.8456 16.125C31.2006 16.125 30.6906 15.6 30.6906 14.97C30.6906 9.645 26.3556 5.325 21.0456 5.325C20.4006 5.325 19.8906 4.8 19.8906 4.17C19.8906 3.54 20.4006 3 21.0306 3C27.6306 3 33.0006 8.37 33.0006 14.97C33.0006 15.6 32.4756 16.125 31.8456 16.125Z" fill="#32548e" />
                            ...
                            <div className="list-nav lg:w-2/3 w-full sm:flex max-sm:grid grid-cols-2 gap-8 justify-between">
                                <div className="item">
                                    ...
                                    <Link href={'#'} className="caption1 text-black has-line block w-fit whitespace-nowrap">Home</Link>
                                    <Link href={'#'} className="caption1 text-black  has-line block w-fit whitespace-nowrap">About us</Link>
                                    <Link href={'#'} className="caption1 text-black  has-line block w-fit whitespace-nowrap">Room</Link>
                                    <Link href={'#'} className="caption1 text-black  has-line block w-fit whitespace-nowrap">Contact</Link>
                                   
                                </div>
                                <div className="item">
                                    <div className="text-title pb-3">Room</div>
                                    <Link href={'/#'} className="caption1 text-black  has-line block w-fit whitespace-nowrap">Chic 1 BHK </Link>
                                    <Link href={'/#'} className="caption1 text-black  has-line block w-fit whitespace-nowrap">Chic Studio</Link>
                                    <Link href={'/#'} className="caption1 text-black  has-line block w-fit whitespace-nowrap">Refined Luxury</Link>
                                    {/* <Link href={'/#'} className="caption1 text-black  has-line block w-fit whitespace-nowrap">Room</Link> */}
                    ...
                    <div className="footer-bottom py-4 border-t border-outline">
                        <div className="container">
                            <div className="flex items-center sm:justify-between justify-center flex-wrap gap-4">
                                <div className="copyright caption1 text-[#446398]">©2025 Aizah Hospitality . All Rights Reserved.</div>
                                <div className="flex items-center gap-3">
                                    <Link href={'/#'} className='caption1 text-[#446398] has-line'>Terms Of Services</Link>
                                    <div className='bg-outline w-px h-4'></div>
                                    <Link href={'/#'} className='caption1 text-[#446398] has-line'>Privacy Policy</Link>
                                    <div className='bg-outline w-px h-4'></div>
                                    <Link href={'/#'} className='caption1 text-[#446398] has-line'>Cookie Policy</Link>
